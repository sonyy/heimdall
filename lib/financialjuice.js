    ...
    const completion = await Promise.race([
      groq.chat.completions.create({
        messages: [
          {
            role: 'system',
            content: `You are a financial market sentiment classifier. Analyze the headline and determine its potential market impact based on your understanding of macroeconomics, geopolitics, trade policy, and monetary policy.
