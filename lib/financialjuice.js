    ...
    const completion = await Promise.race([
      groq.chat.completions.create({
        messages: [
          {
            role: 'system',
            content: `You are a senior financial analyst specializing in Bitcoin and crypto markets. Classify how this headline impacts BTC.

Key rules:
- Do not default to neutral when evidence clearly points in a direction.
- Watch for negation: "peace is NOT realistic" = bearish, not bullish.
- Failed negotiations, diplomatic breakdown, or peace talks collapsing = bearish.
- Failed diplomacy means continued conflict = risk-off = bearish.

Reply ONLY with valid JSON: {"sentiment": "bullish|bearish|neutral", "score": 1-3}
- Score 1 = minimal market impact
- Score 2 = moderate market impact
- Score 3 = significant market impact`
          },
          {
            role: 'user',
