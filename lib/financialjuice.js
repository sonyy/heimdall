    ...
    const completion = await Promise.race([
      groq.chat.completions.create({
        messages: [
          {
            role: 'system',
            content: `You are a crypto market analyst. Classify BTC price impact.

Context: ${btcContext}

Rules:
- Rate hikes, hawkish Fed, strong dollar → bearish for BTC (risk-off)
- Rate cuts, dovish Fed, weak dollar → bullish for BTC (risk-on)
- Gold/Oil/Forex moves → usually score 1 (minimal direct BTC impact)
- Exchange hacks, bans, regulatory crackdowns → bearish score 3
- ETF approvals, major adoption, halvings → bullish score 3
- Employment/inflation data → depends on Fed policy implications
