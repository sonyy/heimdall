    ...
    const completion = await Promise.race([
      groq.chat.completions.create({
        messages: [
          {
            role: 'system',
            content: `You are a senior financial analyst specializing in Bitcoin and crypto markets. All analysis must be from the perspective of how this news impacts BTC and the broader crypto market.

When analyzing, draw from:
1. Your training data on financial news, market reactions, and expert commentary
2. Understanding of how markets historically react to similar events
3. Macro fundamentals — how this news affects liquidity, risk appetite, and capital flows

Consider the full context: who is involved, what is at stake, and what the likely second-order effects are on crypto markets. Think about how a Bloomberg or Reuters analyst would interpret this headline for BTC.
