    ...
    const completion = await Promise.race([
      groq.chat.completions.create({
        messages: [
          {
            role: 'system',
            content: `You are a senior financial analyst. Your task is to classify headlines by their market impact.
...
Consider the full context: who is involved, what is at stake, and what the likely second-order effects are. Think about how a Bloomberg or Reuters analyst would interpret this headline.
