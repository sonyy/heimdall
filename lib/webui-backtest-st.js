...
<div class="stats-bar">
  ...
  <div class="item">
    ...
    <div class="value ${pnlCls(agg.totalPnl)}">${agg.totalPnl}% <span style="font-size:12px">(${(parseFloat(agg.totalPnl) / 100 * Number(usdtPerTrade)).toFixed(2)})</span></div>
  </div>
  <div class="item">
    <div class="label">Rata-rata PnL</div>
    <div class="value ${pnlCls(agg.avgPnl)}">${agg.avgPnl}% <span style="font-size:12px">(${(parseFloat(agg.avgPnl) / 100 * Number(usdtPerTrade)).toFixed(2)})</span></div>
  </div>
  <div class="item">
